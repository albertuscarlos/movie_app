...
class MovieDetailMobileSmall extends StatefulWidget {
  const MovieDetailMobileSmall({
    super.key,
  ...
  @override
  State<MovieDetailMobileSmall> createState() => _MovieDetailMobileSmallState();
}

class _MovieDetailMobileSmallState extends State<MovieDetailMobileSmall> {
  bool rated = false;
  bool favorite = false;
  @override
